 ...
 * @returns Object containing parsed URL and display name representing URL
 *  */
export const parseInternalScmRepositoryUrl = ({ url }: IScmRepositoryUrl): IParsedUrl => {
  ...
  return { url: 'https://' + base + '/gerrit/gitweb?p=' + project + ';a=summary', name: 'Gerrit' };
};
