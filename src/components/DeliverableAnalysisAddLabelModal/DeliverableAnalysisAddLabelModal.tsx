...
import { deliverableAnalysisLabelEntryEntityAttributes } from 'common/deliverableAnalysisLabelEntryEntityAttributes';
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {deliverableAnalysisLabelEntryEntityAttributes.label.values.map((label) => (
              <SelectOption key={label} option={label} />
            ))}
          </Select>
