      ...
      <Toolbar>
        <ToolbarItem reservedWidth>
          <TextContent>
            ...
            <Text>
              This list contains Builds in the Milestone. Builds produced from Build Configuration are assigned to the current
              Milestone in Product Version linked in the Configuration.
            </Text>
          </TextContent>
        </ToolbarItem>
      </Toolbar>
