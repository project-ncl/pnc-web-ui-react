            ...
            <Tbody>
              {serviceContainerScmRepositories.data?.content.map((scmRepository: SCMRepository, rowIndex: number) => (
                <Tr key={rowIndex}>
                  ...
                  <Td>{<ScmRepositoryUrl isInline scmRepository={scmRepository} isInternal showClipboardCopy />}</Td>
                  <Td>
                    {scmRepository.externalUrl && (
                      <ScmRepositoryUrl isInline scmRepository={scmRepository} isInternal={false} showClipboardCopy />
                    )}
                  </Td>
                  <Td>
